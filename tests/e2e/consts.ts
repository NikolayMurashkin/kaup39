 ...
 * эталонные тексты в 1,5%, страницы засева — в 1,7% и на маке, и на Linux; числа next/font у Golos Text
 * дают 2,2% на `/` засева и 2,6% на тексте артборда, у Forum — до 16%, `size-adjust: 100%` — от 5% до 15%.
 */
 ...
 * сдвигаются каждый день, и сумма гарнитуры дат считается с датами строк, поставленными на каждый день года.
 * У строки засева с длинным словом событие не меряется — это нагрузка для теста переносов, а не текст.
 */
