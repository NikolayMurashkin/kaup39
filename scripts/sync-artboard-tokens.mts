...
/**
 * Токены артборда, которых в репозитории быть не должно: это фотографии владельцев
 * из `research/kaup39/media/` — они живут в медиатеке CMS на закрытом стенде (D22),
 * и даже их имена не переносятся в git.
 */
